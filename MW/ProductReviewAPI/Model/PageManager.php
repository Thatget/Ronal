...
use MW\ProductReviewAPI\Api\Data\PageInterfaceFactory;
use MW\ProductReviewAPI\Api\Data\PageSearchResultsInterfaceFactory;
use MW\ProductReviewAPI\Api\PageManagerInterface;
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($collection->getItems() as $page) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $pageDto,
                $page->getData(),
                \MW\ProductReviewAPI\Api\Data\PageInterface::class
            );

...
use MW\ProductReviewAPI\Api\BlockManagerInterface;
use MW\ProductReviewAPI\Api\Data\BlockInterfaceFactory;
use MW\ProductReviewAPI\Api\Data\BlockSearchResultsInterfaceFactory;
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($collection->getItems() as $block) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $blockDto,
                $block->getData(),
                \MW\ProductReviewAPI\Api\Data\BlockInterface::class
            );
